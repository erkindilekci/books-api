...
public class AuthorControllerIntegrationTest {
    ...
    @Test
    public void shouldReturnHttpStatus204WhenDeleteAuthorById() throws Exception {
        Author author = TestDataUtil.createTestAuthorA();
        authorService.saveAuthor(author);
    ...
    @Test
    public void shouldReturnHttpStatus404WhenDeleteNonExistingAuthor() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/authors/0"))
                .andExpect(MockMvcResultMatchers.status().isNotFound());
    }

    @Test
    public void shouldVerifyAuthorIsDeleted() throws Exception {
        Author author = TestDataUtil.createTestAuthorA();
        authorService.saveAuthor(author);
